...
WebUI.click(findTestObject('Object Repository/interaction_with_simple_element/use_this_link_as_text'))

message = WebUI.getText(findTestObject('Object Repository/interaction_with_simple_element/link_success_heading'))

System.out.println(message)

if (message == 'Link success') {
