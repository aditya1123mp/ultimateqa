...
WebUI.click(findTestObject('simple_controls/go_to_login_page'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('simple_controls/click_on_the_link_create_new_account'), 10)

WebUI.delay(2)

WebUI.click(findTestObject('simple_controls/click_on_the_link_create_new_account'))
